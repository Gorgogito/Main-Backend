...
namespace Main.Infrastructure.Repository
{
    public class AccessControlRepository: IAccessControlRepository
    {
        ...
        public AccessControlRepository(IConnectionFactory connectionFactory, ILogger logger)
        {
        ...
        public async Task<AccessControl> GetByIdAsync(string code)
        {
            try
            {
                using (var connection = _connectionFactory.GetConnection)
                {
                    ...
                    parameters.Add("@Code", code);
                    var query = "[dbo].[AccessControlGetByID]";
                    entity = await connection.QuerySingleAsync<AccessControl>(query, param: parameters, commandType: CommandType.StoredProcedure);
                    _logger.InfoFormat("[{0}-{1}] - {2}", this.GetType().Name, MethodBase.GetCurrentMethod().Name, "Consulta Exitosa!!!");
                    return entity;
                }
            }
        ...
        public async Task<IEnumerable<AccessControl>> GetByResourceAsync(string codeResource)
        {
            try
            {
                using (var connection = _connectionFactory.GetConnection)
                {
                    ...
                    parameters.Add("@CodeResource", codeResource);
                    var query = "[dbo].[AccessControlGetByResource]";
                    var entity = await connection.QueryAsync<AccessControl>(query, param: parameters, commandType: CommandType.StoredProcedure);
                    _logger.InfoFormat("[{0}-{1}] - {2}", this.GetType().Name, MethodBase.GetCurrentMethod().Name, "Consulta Exitosa!!!");
                    return entity;
                }
            }
        ...
        public async Task<IEnumerable<AccessControl>> ListAsync()
        {
            try
            {
                ...
                {
                    var query = "[dbo].[AccessControlList]";
                    var entity = await connection.QueryAsync<AccessControl>(query, commandType: CommandType.StoredProcedure);
                    _logger.InfoFormat("[{0}-{1}] - {2}", this.GetType().Name, MethodBase.GetCurrentMethod().Name, "Consulta Exitosa!!!");
                    return entity;
                }
            }
